...
import { cmsPagesQuery, homeSectionsQuery, siteSettingsQuery } from '@/lib/queries';
...
function AdminOverview() {
  ...
  return (
    <div>
      ...
      <p className="text-muted-foreground mt-2">Everything powering nazexa.com, in one place.</p>
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2">
        {cards.map((c) => (
          <Link key={c.to} href={c.to} className="surface-card hover-lift block p-5">
