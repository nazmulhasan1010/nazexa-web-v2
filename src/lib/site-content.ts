...
export const defs: [string, string, string, string, [string, string][]][] = [
  [
    ...
    [
      ['Our mission', 'Remove the undifferentiated work between an idea and a shipped product.'],
      [
        'Our principles',
        'Craft over noise, speed with safety, and radical clarity in everything we build.',
      ],
      ['Our people', '180 engineers, designers and operators across 24 countries.'],
    ],
  ],
  [
    'products',
    ...
    [
      ['Nazexa Core', 'Managed Postgres, edge functions and object storage under one API.'],
      ['Nazexa AI', 'Embeddings, agents and evaluation pipelines with usage-based billing.'],
      ['Nazexa Insight', 'Product analytics, tracing and alerting with no extra agents.'],
    ],
  ],
  [
    'product-details',
    ...
    [
      ['Live preview', 'Branch your database, preview it, then merge with a single command.'],
      ['Interactive screenshots', 'Explore the console, schema designer and query profiler.'],
  ...
  [
    ...
    [
      ['Platform engineering', 'We design and operate your internal developer platform.'],
      ['Migration services', 'Move off legacy infrastructure with zero downtime.'],
      ['Enablement', 'Workshops and pairing that leave your team faster than we found it.'],
    ],
  ],
  [
    'service-details',
    ...
    [
      ['Discovery', 'Two-week audit of your current architecture and delivery flow.'],
  ...
  [
    ...
    [
      ...
      ['Scale-ups', 'Multi-region, compliance-ready infrastructure without a platform team.'],
  ...
  [
    ...
    [
      ['Design systems', 'Component libraries adopted by 300+ internal engineers.'],
  ...
  [
    ...
    [
      ['REST', 'Predictable resources, cursor pagination and idempotency keys.'],
  ...
  [
    ...
    [
      ['Weekly releases', 'New capabilities every Thursday, backwards compatible by default.'],
      ['Deprecation policy', '12 months notice with automated migration guidance.'],
  ...
  [
    ...
    [
      ...
      ['Team', 'Usage-based pricing with spend caps, SSO and preview environments.'],
  ...
  [
    ...
    [
      ...
      ['Benchmarks', 'Reproducible performance work with published methodology.'],
    ],
  ],
  [
    'blog',
  ...
  [
    ...
    [
      ...
      ['Benefits', 'Equity, generous leave, hardware budget and learning stipend.'],
  ...
  [
    ...
    [
      ...
      ['Engineering', 'Distributed systems, developer experience and security.'],
  ...
  [
    ...
    [
      ...
      ['Data protection', 'Encrypted at rest and in transit with customer-managed keys.'],
  ...
  [
    ...
    [
      ['Data we collect', 'Only what is needed to run and improve the service.'],
...
export const pages: Record<string, PageContent> = Object.fromEntries(
  defs.map(([slug, eyebrow, title, description, features]) => {
    const base = standard(slug, eyebrow, title, description, features, genericList, genericFaq);
