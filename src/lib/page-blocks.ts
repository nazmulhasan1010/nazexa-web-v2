    ...
    blocks: [
      ...
      },
      {
        ...
        rows: [
          ...
          ['Self-managed distribution', 'Enterprise', 'Enterprise', 'Enterprise'],
        ],
      },
      {
        kind: 'features',
      ...
      },
      {
        ...
        items: [
          {
            quote: 'We deleted four vendors and a 3,000-line Terraform module in the first month.',
            name: 'Priya Raman',
...
nz branch merge pr-482 --into main --strategy migrate`,
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            quote: 'The handover was the best part — our team can operate all of it without them.',
            name: 'Marc Fischer',
    ...
    blocks: [
      {
        ...
        rows: [
          ...
          ['Reliability', 'SLO definition, on-call design, incident review facilitation', 'Weekly'],
          ['Cost engineering', 'Spend attribution, right-sizing, commitment planning', 'Monthly'],
          ['Security posture', 'Threat modelling, policy-as-code, access review', 'Quarterly'],
  ...
  solutions: {
    tone: 'brand-2',
    heroVariant: 'center',
    intro: 'Paved roads for the three moments that matter: launching, scaling and consolidating.',
    blocks: [
      {
        kind: 'cards',
        title: 'By stage',
      ...
      },
      {
        ...
        items: [
          ...
          {
            quote: "We passed a bank's security review in nine days using the evidence pack.",
            name: 'Ken Abara',
  ...
  industries: {
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          {
            quote: 'Our auditors accepted the evidence pack without a single follow-up request.',
            name: 'Elena Kovač',
    ...
    blocks: [
      ...
      },
      {
        ...
        rows: [
          ...
          ['Vantage Retail', '3 peak incidents', '0 peak incidents', '1 season'],
...
# { "id": "brn_2f91", "status": "ready", "created_at": "2026-08-08T10:12:44Z" }`,
  ...
  changelog: {
    tone: 'brand-2',
    heroVariant: 'minimal',
    intro: 'Everything we shipped, newest first. Backwards compatible unless explicitly marked.',
    blocks: [
      {
        kind: 'timeline',
  ...
  roadmap: {
    tone: 'brand-2',
    heroVariant: 'center',
    intro: 'What we are rolling out, building and exploring. Dates are intentions, not contracts.',
    blocks: [
      {
        kind: 'cards',
  ...
  'learning-center': {
    ...
    blocks: [
      ...
      },
      {
        ...
        rows: [
          ['Nazexa Certified Developer', 'Foundations path + 60-minute practical exam', '2 years'],
          ['Nazexa Certified Architect', 'Production path + case study submission', '2 years'],
          ['Nazexa AI Specialist', 'Data & AI path + evaluation project', '2 years'],
        ],
      },
      {
        kind: 'cta',
...
\`);`,
  ...
  news: {
    tone: 'brand-3',
    heroVariant: 'minimal',
    intro: 'Official announcements, funding news, partnerships and press coverage.',
    meta: [
  ...
  community: {
    tone: 'brand-2',
    heroVariant: 'center',
    intro: '20,000 builders sharing patterns, plugins, benchmarks and the occasional war story.',
    blocks: [
      {
        kind: 'stats',
...
cosign verify-blob \\
  ...
  terms: {
    tone: 'brand-3',
    heroVariant: 'minimal',
    intro: 'Last updated 1 July 2026. These terms govern your use of Nazexa products and services.',
    meta: [
      { label: 'Effective', value: '1 July 2026' },
  ...
  'cookie-policy': {
    tone: 'brand-3',
    heroVariant: 'minimal',
    intro: 'Last updated 1 July 2026. What we store in your browser, why, and how to change it.',
    meta: [
      { label: 'Effective', value: '1 July 2026' },
    ...
    blocks: [
      {
        ...
        rows: [
          ['nz_session', 'Keeps you signed in to the console', 'Essential', '30 days'],
          ['nz_csrf', 'Protects form submissions from forgery', 'Essential', 'Session'],
          ['nz_theme', 'Remembers light or dark preference', 'Preference', '1 year'],
          ['nz_consent', 'Stores your cookie choices', 'Essential', '1 year'],
          ['nz_analytics', 'Aggregate, cookie-less page measurement', 'Analytics', '24 hours'],
        ],
      },
      {
        kind: 'legal',
    ...
    blocks: [
      {
        ...
        rows: [
          ['P1', 'Production down or data at risk', 'Community', '4 hours', '15 minutes'],
          ['P2', 'Major feature degraded', 'Community', '8 hours', '2 hours'],
          ['P3', 'Minor issue with a workaround', 'Community', '1 business day', '8 hours'],
          ['P4', 'Question or feature guidance', 'Community', '2 business days', '1 business day'],
        ],
      },
      {
        kind: 'channels',
  ...
  'feature-requests': {
    ...
    blocks: [
      ...
      },
      {
        ...
        rows: [
          ['Under review', 'Triaged, gathering demand and context', '1–4 weeks'],
          ['Planned', 'Committed to a quarter on the roadmap', '1–2 quarters'],
          ['In progress', 'Actively being built, beta flag likely available', '4–12 weeks'],
          ['Shipped', 'Generally available, linked to the changelog entry', '—'],
