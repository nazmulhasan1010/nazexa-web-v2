  ...
  return (
    <section className="relative isolate flex min-h-[92vh] items-center overflow-hidden pt-24">
      ...
      <div className="mx-auto w-full max-w-6xl px-5 text-center">
        ...
        <h1 className="mx-auto mt-8 max-w-4xl text-5xl font-semibold leading-[1.02] sm:text-7xl">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
            <Magnetic>
              <Button
                asChild
                size="lg"
                className="glow-ring h-12 px-7 text-base"
              >
                <Link href="/contact">
        ...
        <div>
          <Reveal>
            ...
            <p className="mt-4 text-muted-foreground">
              Stop stitching six vendors together. Nazexa gives you one mental
              model, one bill, and one place to debug when something goes wrong
              at 3am.
            </p>
          </Reveal>
            ...
            {rows.map((r, i) => (
              <Reveal key={r.title} variant="left" delay={i * 110}>
                <div className="flex gap-4">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-secondary ring-1 ring-border">
        ...
        <Reveal variant="right" delay={120}>
          <div className="surface-card relative overflow-hidden p-5">
            <div className="mb-4 flex items-center justify-between">
              ...
              <span className="rounded-full bg-primary/12 px-2 py-0.5 text-[10px] uppercase tracking-widest text-primary">
                live preview
              </span>
            </div>
  ...
  return (
    <Section title="Company timeline">
      <div className="relative border-l border-border pl-8">
        <span className="absolute left-0 top-0 h-full w-px bg-gradient-to-b from-primary/70 via-primary/20 to-transparent" />
        {events.map((e, i) => (
          <Reveal key={e.year} variant="left" delay={i * 100}>
            <div className="relative pb-10">
              <span className="absolute -left-[38px] top-1.5 flex h-3 w-3 items-center justify-center rounded-full bg-primary ring-4 ring-background" />
      ...
      <div className="flex flex-wrap gap-2.5">
        {tech.map((t, i) => (
          <Reveal key={t} variant="zoom" delay={i * 45}>
            <span className="surface-card hover-lift inline-block px-4 py-2 font-mono text-xs text-muted-foreground">
              {t}
            </span>
          </Reveal>
        ))}
      ...
      <div className="grid gap-5 lg:grid-cols-3">
        {posts.map((p, i) => (
          <Reveal key={p.title} delay={i * 100}>
            ...
            >
              <div className="relative h-36 overflow-hidden bg-secondary/40">
                <AuroraBackground />
      ...
      <Reveal variant="zoom">
        <div className="surface-card glow-ring relative isolate overflow-hidden p-10 text-center sm:p-20">
          ...
          <h2 className="mx-auto max-w-2xl text-3xl font-semibold sm:text-5xl">
            Ship your next release on{" "}
            <span className="text-gradient">Nazexa</span>
          </h2>
          <p className="mx-auto mt-5 max-w-xl text-muted-foreground">
            Start free in under a minute. Invite your team, connect your repo,
            and deploy to production today.
          </p>
          <form
