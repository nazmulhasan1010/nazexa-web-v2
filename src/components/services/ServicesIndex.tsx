      ...
      <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {finalServices.slice(0, 6).map((s, i) => (
          <Reveal key={s.slug} delay={(i % 3) * 80}>
            ...
            >
              <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-primary/12 ring-1 ring-primary/25 transition-transform duration-300 group-hover:scale-110">
...
function ServicesHero() {
  return (
    <div>
      <section className="relative isolate overflow-hidden pb-14 pt-36">
        <AuroraBackground />
        ...
        <div className="mx-auto max-w-5xl px-5 text-center">
          ...
          <Reveal variant="up" delay={150}>
            <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
              Nazexa builds its own developer products — and builds software for
              clients. From custom platforms and Android apps to APIs,
              databases, cloud infrastructure and technology consulting, we take
              an idea from discovery to a maintained production system.
            </p>
          </Reveal>
...
function ServicesBody({ servicesList }: { servicesList: any[] }) {
  return (
    <div>
      ...
      <section className="relative isolate overflow-hidden border-y border-border py-16">
        <AuroraBackground />
          ...
          <Reveal variant="left">
            <div>
              ...
              <p className="mt-4 text-muted-foreground">
                Nazexa exists to remove the distance between an idea and a
                working product. We combine product thinking, modern engineering
                and long-term maintainability so the systems we deliver keep
                paying off years after launch.
              </p>
              <p className="mt-4 text-muted-foreground">
                <span className="font-medium text-foreground">Our vision:</span>{" "}
                to be the technology partner teams trust for everything from a
                first prototype to a platform serving millions — building
                software that is fast, secure and genuinely maintainable.
              </p>
            </div>
          </Reveal>
        ...
        <Reveal variant="zoom">
          <div className="surface-card glow-ring relative isolate overflow-hidden p-10 text-center sm:p-16">
            ...
            <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
              Tell us the problem you are solving. You will get an honest
              assessment, a proposed approach and a written estimate — usually
