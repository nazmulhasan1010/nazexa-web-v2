    ...
    <div className="flex flex-col">
      ...
      <div className="bg-muted/20 relative h-48 w-full overflow-hidden">
          ...
          <defs>
            ...
            >
              <path
                ...
                fill="none"
                stroke="url(#tech-gradient-security)"
                strokeWidth="1.5"
                strokeLinecap="round"
        ...
        <div className="absolute bottom-6 left-8 flex items-center gap-5">
          <div className="border-background bg-background flex h-16 w-16 items-center justify-center rounded-2xl border-4 shadow-xl">
            <ShieldCheck className="text-foreground h-8 w-8" />
          </div>
          <div>
            <h2 className="text-foreground text-3xl font-bold tracking-tight">Security Center</h2>
      ...
      <div className="flex flex-col gap-8 p-8">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          <div className="border-border/50 from-muted/40 to-muted/10 relative overflow-hidden rounded-2xl border bg-gradient-to-br p-5">
            <div className="flex flex-col gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-emerald-500/10 text-emerald-500">
                <ShieldCheck className="h-5 w-5" />
              </div>
              <div>
                <p className="text-foreground text-sm font-semibold">Account Status</p>
                <p className="text-muted-foreground mt-0.5 text-xs">Protected & Secure</p>
              </div>
            </div>
          </div>

          <div className="border-border/50 from-muted/40 to-muted/10 relative overflow-hidden rounded-2xl border bg-gradient-to-br p-5 opacity-70">
            <div className="flex flex-col gap-3">
              ...
              <Button
                variant="link"
                className="mt-1 h-auto justify-start p-0 text-xs text-blue-500"
              >
                Configure &rarr;
              </Button>
            </div>
          ...
          <div className="border-border/50 from-muted/40 to-muted/10 relative overflow-hidden rounded-2xl border bg-gradient-to-br p-5 opacity-70">
            <div className="flex flex-col gap-3">
              ...
              <div>
                <p className="text-foreground text-sm font-semibold">Passkeys</p>
                <p className="text-muted-foreground mt-0.5 text-xs">0 passkeys registered</p>
              </div>
              <Button
                variant="link"
                className="mt-1 h-auto justify-start p-0 text-xs text-violet-500"
              >
                Add Passkey &rarr;
              </Button>
            </div>
        ...
        <div className="border-border/50 bg-background/50 overflow-hidden rounded-2xl border shadow-sm">
          <div className="border-border/50 bg-muted/20 border-b px-6 py-5">
          ...
          <div className="p-6 sm:p-8">
            {!user.hasPassword ? (
              <Form {...setForm}>
                <form onSubmit={setForm.handleSubmit(onSetSubmit)} className="max-w-md space-y-6">
                  <FormField
                      ...
                      <FormItem className="space-y-2">
                        ...
                        <FormControl>
                          <Input
                            ...
                            className="bg-background/50 focus:bg-background h-11 text-base transition-all"
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
                  ...
                  <div className="pt-4">
                    <Button
                      type="submit"
                      disabled={isUpdating}
                      className="h-11 w-full px-8 shadow-md transition-all hover:shadow-lg sm:w-auto"
                    >
              ...
              <Form {...changeForm}>
                ...
                >
                  ...
                  <div className="from-border/50 via-border my-6 h-px w-full bg-gradient-to-r to-transparent" />
        ...
        <div className="rounded-2xl border border-red-500/20 bg-red-500/5 p-6 sm:p-8">
          <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
            ...
            <Button variant="destructive" className="shadow-sm sm:self-center">
              Deactivate Account
            </Button>
          </div>
        </div>
