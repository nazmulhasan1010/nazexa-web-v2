...
1. **Test Files**: Never create test scripts, HTML test files, or test components in the project root directory or public folder. All test files MUST be placed inside the existing 	ests folder or its appropriate subdirectories.
